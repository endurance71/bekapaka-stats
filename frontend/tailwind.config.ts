        ...
        extend: {
            colors: {
                bkpk: {
                    ...
                    'text-soft': 'var(--bkpk-text-soft)',
                    'text-danger': 'var(--bkpk-text-danger)',
                    'text-danger-subtle': 'var(--bkpk-text-danger-subtle)',
                    'text-disabled': 'var(--bkpk-text-disabled)',
                    'on-primary': 'var(--bkpk-on-primary)',
