                    ...
                    <div className="flex flex-col md:flex-row items-center justify-center gap-12 md:gap-24 relative">
                        ...
                        >
                            <div className="relative group">
                                ...
                                <div className="relative w-24 h-24 md:w-32 md:h-32 bg-bkpk-surface-tint-2 rounded-full flex items-center justify-center text-5xl font-black text-bkpk-primary border-2 border-bkpk-primary/30 shadow-[0_0_40px_rgba(255,107,53,0.15)] ring-8 ring-bkpk-navy-light/30">
                                    {bekapaka.name.charAt(0)}
                                </div>
                            </div>
                            <h2 className="text-3xl md:text-4xl font-black font-outfit text-bkpk-text-primary mt-6 tracking-tight">{bekapaka.name}</h2>
                            <div className="flex items-center gap-2 mt-2">
                                <div className="px-3 py-1 bg-bkpk-surface-tint-4 border border-bkpk-border-strong rounded-full text-caption-bold text-bkpk-text-secondary">
                                    {bekapaka.record}
                                </div>
                                <span className="text-bkpk-text-muted text-caption uppercase tracking-widest">{bekapaka.rank ? `${bekapaka.rank}. miejsce` : '-'}</span>
                            </div>
                        </motion.div>
                        ...
                        <motion.div
                            ...
                            className="flex flex-col items-center relative py-8 md:py-0"
                        >
                            <div className="text-7xl md:text-8xl font-black font-outfit text-white/5 italic select-none absolute top-1/2 -translate-y-1/2" aria-hidden="true">
                                VS
                            </div>
                            <div className="relative z-10 flex flex-col items-center">
                                <div className="w-12 h-1 bg-gradient-to-r from-transparent via-bkpk-primary to-transparent rounded-full mb-4 shadow-[0_0_10px_rgba(255,107,53,0.5)]" />
                                <div className="bg-bkpk-navy-light/80 backdrop-blur-md border border-bkpk-border-strong px-4 py-1.5 rounded-full text-caption-bold uppercase tracking-[0.3em] text-bkpk-primary shadow-2xl">
                                    Raport Scoutingowy
                                </div>
                                <div className="w-12 h-1 bg-gradient-to-r from-transparent via-bkpk-primary to-transparent rounded-full mt-4 shadow-[0_0_10px_rgba(255,107,53,0.5)]" />
                            </div>
                        </motion.div>
                        ...
                        >
                            <div className="relative group">
                                ...
                                <div className="relative w-24 h-24 md:w-32 md:h-32 bg-bkpk-surface-tint-2 rounded-full flex items-center justify-center text-5xl font-black text-bkpk-text-primary border-2 border-bkpk-border-strong shadow-[0_0_40px_rgba(255,255,255,0.05)] ring-8 ring-bkpk-navy-light/30">
                                    {opponent.name.charAt(0)}
                                </div>
                            </div>
                            <h2 className="text-3xl md:text-4xl font-black font-outfit text-bkpk-text-primary mt-6 tracking-tight">{opponent.name}</h2>
                            <div className="flex items-center gap-2 mt-2">
                                <div className="px-3 py-1 bg-bkpk-surface-tint-4 border border-bkpk-border-strong rounded-full text-caption-bold text-bkpk-text-secondary">
                                    {opponent.record}
                                </div>
                                <span className="text-bkpk-text-muted text-caption uppercase tracking-widest">{opponent.rank ? `${opponent.rank}. miejsce` : '-'}</span>
                            </div>
                        </motion.div>
                    </div>
                </div>
                                ...
                                <table className="w-full text-left border-collapse">
                                    <thead>
                                        <tr className="text-sm font-bold text-bkpk-text-muted uppercase tracking-widest border-b border-bkpk-border-strong">
                                            ...
                                            <th className="pb-3 text-center">Suma</th>
                                        </tr>
                                    </thead>
                                        ...
                                        {keyPlayers.map((p: any, i: number) => (
                                            <tr key={i} className="border-b border-bkpk-border-strong last:border-0 hover:bg-bkpk-surface-tint-3 transition-colors">
                                                <td className="py-3 pl-2 font-bold text-bkpk-text-primary">
                                                    <span className="inline-flex items-center justify-center w-5 h-5 rounded bg-bkpk-surface-tint-4 text-caption text-bkpk-text-secondary mr-2">
                                                        {i + 1}
                                                    </span>
                                                    {p.name}
                                                </td>
